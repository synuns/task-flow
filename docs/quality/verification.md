...
| `user-crud` | `USER-CRUD-01..08`, `USER-LOGOUT-01..05`; `/sign-in`, `/sign-up`, `/user`, `POST/GET/PATCH/DELETE /api/user`, `POST /api/sign-out` | `src/entities/user`, `src/features/sign-up`, `src/features/update-user`, `src/features/delete-user`, `src/features/sign-out`, `src/shared/api/user.ts`, `src/shared/api/auth.ts` | `e2e/user-crud.spec.ts` |
